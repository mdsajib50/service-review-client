...
const Review = ({service}) => {
    ...
    const handelReview = (e) =>{
        ...
        const reviewId =reviews.filter((value, index, array) => {})(review => review.review_id)
        // const idValue = reviewId.toString()
        console.log(reviewId)
         console.log(reviewId.toString().split(' '))
        // console.log([_id])
        const idValue = [_id]
    return (
        <div>
        ...
        <button className="btn btn-outline btn-success mb-10 ml-4">Submit</button>
            ...
            {
                JSON.stringify(reviewId) === JSON.stringify(idValue) ?
