...
const Login = () => {
    ...
    const handelLogin = e =>{
     ...
     const handelGoogleLogin =()=>{
         ...
         .then(result =>{const userresult.user})
         .catch((e) => {
             console.error(e)
         })
    }
        ...
        <div className="hero w-full mt-12">
            <div className="hero-content grid gap-20 md:grid-cols-2 flex-col lg:flex-row">
                ...
                <div className="card flex-shrink-0 w-full max-w-lg shadow-2xl py-14">
                    ...
                    <p className='text-center'>Log in with Google<button onClick={handelGoogleLogin} className='font-bold text-green-400'>Google</button></p>
